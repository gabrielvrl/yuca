...
function Home({ history }) {
    ...
    const [apartment, setApartment] = useState({
        ...
        number: 0,
        room: "X",
        subwayStation: { name: "Estação", distance: "0m" },
    });
    useEffect(() => {
    ...
    return (
        <div className="containerHome" data-testid="container-home">
            ...
            <div className="infoDiv">
                ...
                {/* <img src={apartamentPhoto} alt="Apartament" /> */}{" "}
                ...
                <div className="subInfoDiv">
                    ...
                    <div className="imgAndSubway">
                        <img
                            ...
                            alt="Metro"
                            style={{
                                backgroundColor: "#FAA446",
                                width: "16px",
                                height: "16px",
                                border: "2px solid #FAA446",
                                borderRadius: "50%",
                            }}
                        />
                        <h6
                        ...
                        >
                            {apartment.subwayStation.name}{" "}
                            {apartment.subwayStation.distance}
                        </h6>
                    </div>
